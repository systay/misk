...
class GrpcConnectivityTest {
  ...
  fun happyPath() {
    ...
    // Flipping this will cause this request to call the GRPC 'hell world' example service.
    if (false) {
  ...
  class HelloRpcAction : WebAction {
    ...
    @RequestContentType(MediaTypes.APPLICATION_GRPC)
    @ResponseContentType(MediaTypes.APPLICATION_GRPC)
